...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, asChild, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-primary-light text-primary hover:bg-primary-medium/20 focus:ring-primary',
      outline: 'bg-white text-primary border border-primary hover:bg-primary-light focus:ring-primary',
      ghost: 'text-text2 hover:text-primary hover:bg-primary-light/20 focus:ring-primary',
